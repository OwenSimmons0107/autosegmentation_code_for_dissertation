...
#this script resampled the images to work for training
...
for patient in patients:
    # Read the CT volume
    ct_volume = sitk.ReadImage(os.path.join(f"{input_dir}/CT_images", patient))
    ...
    segmentation_volume = sitk.ReadImage(os.path.join(f"{input_dir}/mask_images", patient))
